...
router.post("/payment/:id", auth, checkRole(["admin", "user"]), Transaksi.getSnapRedirect)
router.get('/payment/success',auth,checkRole(['admin','user']), Transaksi.midtransCallback)
